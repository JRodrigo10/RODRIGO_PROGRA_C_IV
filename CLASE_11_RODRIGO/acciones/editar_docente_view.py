...
class EditarDocenteView(ft.Container):
    def __init__(self, page, docente_id, volver_atras=None):
    ...
    def volver_a_docentes(self, e=None):
        """Regresa a la vista principal de docentes o navega según volver_atras."""
        ...
        if callable(self.volver_atras):
            ...
            self.page.clean()
            self.page.add(DocentesView(self.page, volver_atras=lambda: print("Volver desde docentes_view por defecto")))
            self.page.update()
