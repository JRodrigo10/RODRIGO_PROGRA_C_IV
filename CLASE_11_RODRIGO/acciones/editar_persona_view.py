...
class EditarPersonaView(ft.Container):
    def __init__(self, page, persona_id, volver_atras=None):
    ...
    # ───────────────────────────────
    def volver_a_personas(self, e=None):
        ...
        if callable(self.volver_atras):
            ...
            self.page.clean()
            self.page.add(PersonasView(self.page, volver_atras=lambda: print("Volver desde personas_view por defecto")))
            self.page.update()
