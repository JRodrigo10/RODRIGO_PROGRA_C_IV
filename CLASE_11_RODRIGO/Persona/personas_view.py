...
class PersonasView(ft.Container):
    """
    Vista para gestión de personas.
    Args:
        page: Objeto Page.
        volver_atras: Función invocada al pulsar el botón volver.
    Ejemplo:
        PersonasView(page, volver_atras=lambda: ...)
    """
    ...
    def mostrar_formulario_editar(self, persona_id):
        ...
        from acciones.editar_persona_view import EditarPersonaView
        editar_vista = EditarPersonaView(self.page, persona_id, volver_atras=lambda: self.recargar_y_mantener_volver())
        self.page.clean()
    ...
    def recargar_y_mantener_volver(self):
        self.page.clean()
        self.page.add(PersonasView(self.page, volver_atras=self.volver_atras))
        self.page.update()
