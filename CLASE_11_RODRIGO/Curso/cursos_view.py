...
class CursosView(ft.Container):
    ...
    Args:
        ...
        volver_atras: Función que se llama al pulsar el botón Volver.
    Ejemplo correcto:
        CursosView(page, volver_atras=lambda: cambiar_vista(...))
    """
    ...
    def mostrar_formulario_editar(self, curso_id):
        ...
        editar_vista = EditarCursoView(self.page, curso_id, volver_atras=lambda: self.recargar_y_mantener_volver())
        self.page.clean()
    ...
    def recargar_y_mantener_volver(self):
        self.page.clean()
        self.page.add(CursosView(self.page, volver_atras=self.volver_atras))
        self.page.update()
