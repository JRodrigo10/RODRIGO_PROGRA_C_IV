...
def main(page: ft.Page):
    ...
    page.window.center()
    page.title = "Sistema - Online de Reservaciones o venta de Cupos para Viajes Turísticos En el Modo Usuario"
    ...
    page.add(
        ft.Column(
            [
                ft.Text("🌈 RESERVACIONES DE CUPOS Y VENTAS EN EL MODO VISITANTE PARA VIAJES TURÍSTICOS POR EL PERÚ ☄",
                        size=29, weight=ft.FontWeight.BOLD, color="#EE10E3"),
